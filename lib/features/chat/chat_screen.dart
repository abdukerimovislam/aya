...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _sendMessage() {
    ...
    chatProvider.sendMessage(text, cycleProvider, wellnessProvider, l10n);
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color(0xFF8E71C7).withValues(alpha: 0.15),
                boxShadow: [BoxShadow(color: const Color(0xFF8E71C7).withValues(alpha: 0.2), blurRadius: 100)],
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppColors.primary.withValues(alpha: 0.15), blurRadius: 120)],
              ),
            ),
          ),
          ...
          child: Row(
            children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: const Color(0xFF8E71C7).withValues(alpha: 0.4), blurRadius: 8)],
                    ),
              ...
              Column(
                ...
                children: [
                  Text(l10n.chatTitle, style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
                  Text(l10n.chatStatusOnline, style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.textSecondary)),
                ],
              ),
              const Spacer(),
              IconButton(
                icon: Icon(CupertinoIcons.trash, size: 20, color: AppColors.textSecondary.withValues(alpha: 0.5)),
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            if (!isUser) BoxShadow(color: Colors.black.withValues(alpha: 0.02), blurRadius: 10, offset: const Offset(0, 4)),
            if (isUser) BoxShadow(color: AppColors.primary.withValues(alpha: 0.2), blurRadius: 10, offset: const Offset(0, 4)),
          ],
        ),
        child: Text(
          text,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 12),
            Text(l10n.chatTyping, style: GoogleFonts.inter(fontSize: 13, color: AppColors.textSecondary, fontStyle: FontStyle.italic)),
          ],
        ),
      ),
    );
  ...
  Widget _buildInputArea(BuildContext context, AppLocalizations l10n) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(top: BorderSide(color: AppColors.textPrimary.withValues(alpha: 0.05))),
      ),
      child: Row(
